...
const PROGRAMS = {
  "Teozilla":{
    desc:"중급자 이상 주 5일 분할. 메인 리프트 top set + back-off set 구조로 점진적 과부하를 극대화합니다.",
    days:[
      {name:"Day 1 — 가슴/등/어깨/팔", exercises:[
        {name:"덤벨 풀오버",sets:3,rir:0,targetReps:12,weight:""},
        {name:"벤치프레스 (top)",sets:1,rir:2,targetReps:3,weight:"1RM의 85%"},
        {name:"벤치프레스 (back-off)",sets:1,rir:1,targetReps:6,weight:"1RM의 70%"},
        {name:"팬들레이 로우",sets:3,rir:1,targetReps:8,weight:"1RM의 75%"},
        {name:"머신 숄더프레스",sets:4,rir:0,targetReps:12,weight:""},
        {name:"체스트 플라이",sets:4,rir:0,targetReps:12,weight:""},
        {name:"사이드 레터럴 레이즈",sets:3,rir:0,targetReps:15,weight:""},
        {name:"EZ바 컬",sets:3,rir:0,targetReps:12,weight:""},
        {name:"케이블 푸시다운",sets:3,rir:0,targetReps:12,weight:""},
      ]},
      {name:"Day 2 — 하체", exercises:[
        {name:"스쿼트 (top)",sets:1,rir:2,targetReps:3,weight:"1RM의 85%"},
        {name:"스쿼트 (back-off)",sets:1,rir:1,targetReps:6,weight:"1RM의 70%"},
        {name:"레그프레스",sets:6,rir:1,targetReps:10,weight:""},
        {name:"힙 쓰러스트",sets:4,rir:1,targetReps:10,weight:""},
        {name:"레그 익스텐션",sets:4,rir:0,targetReps:12,weight:""},
        {name:"레그 컬",sets:4,rir:0,targetReps:12,weight:""},
        {name:"Grip Hold",sets:2,rir:0,targetReps:30,weight:""},
      ]},
      {name:"Day 3 — 전신", exercises:[
        {name:"풀업",sets:3,rir:1,targetReps:8,weight:""},
        {name:"OHP",sets:3,rir:1,targetReps:6,weight:"1RM의 70%"},
        {name:"랫풀다운 (케이블)",sets:3,rir:1,targetReps:10,weight:""},
        {name:"하이 로우",sets:3,rir:1,targetReps:10,weight:""},
        {name:"머신 인클라인 체스트",sets:3,rir:1,targetReps:10,weight:""},
        {name:"사이드 레터럴 레이즈",sets:4,rir:0,targetReps:15,weight:""},
        {name:"푸시업",sets:1,rir:0,targetReps:20,weight:""},
        {name:"케이블 컬",sets:4,rir:0,targetReps:12,weight:""},
        {name:"케이블 푸시다운",sets:3,rir:0,targetReps:12,weight:""},
        {name:"벤트오버 레터럴 레이즈",sets:3,rir:0,targetReps:15,weight:""},
      ]},
      {name:"Day 4 — 하체 데드", exercises:[
        {name:"데드리프트 (top)",sets:1,rir:2,targetReps:3,weight:"1RM의 85%"},
        {name:"데드리프트 (pause)",sets:1,rir:1,targetReps:6,weight:"1RM의 70%"},
        {name:"레그프레스",sets:4,rir:1,targetReps:10,weight:""},
        {name:"워킹 런지",sets:2,rir:0,targetReps:12,weight:""},
        {name:"레그 익스텐션",sets:4,rir:0,targetReps:12,weight:""},
        {name:"레그 컬",sets:4,rir:2,targetReps:12,weight:""},
      ]},
      {name:"Day 5 — 머신 데이", exercises:[
        {name:"머신 인클라인 체스트",sets:3,rir:1,targetReps:12,weight:""},
        {name:"머신 플랫 체스트",sets:3,rir:1,targetReps:12,weight:""},
        {name:"머신 숄더프레스",sets:3,rir:1,targetReps:12,weight:""},
        {name:"랫풀다운 (케이블)",sets:3,rir:1,targetReps:10,weight:""},
        {name:"시티드 로우 (케이블)",sets:3,rir:1,targetReps:10,weight:""},
      ]},
    ]
  },
  "Mad Cow (5x5)":{
    desc:"빌 스타의 5x5 기반 초중급 프로그램. 주 3일 A/B 교대.\n5세트 × 5렙, 무게는 5렙 가능한 무게(약 1RM의 85%).\n매 세션마다 2.5kg씩 증량.\n\n⚠️ 5회 3세트 연속 실패 시 90%로 리셋",
    days:[
      {name:"A일 — 스쿼트/벤치/로우", exercises:[
        {name:"스쿼트 (바벨)",sets:5,rir:1,targetReps:5,weight:"5렙 가능 무게 (약 1RM 85%)"},
        {name:"벤치프레스 (바벨)",sets:5,rir:1,targetReps:5,weight:"5렙 가능 무게 (약 1RM 85%)"},
        {name:"바벨 로우",sets:5,rir:1,targetReps:5,weight:"5렙 가능 무게 (약 1RM 85%)"},
      ]},
      {name:"B일 — 스쿼트/OHP/데드", exercises:[
        {name:"스쿼트 (바벨)",sets:5,rir:1,targetReps:5,weight:"5렙 가능 무게 (약 1RM 85%)"},
        {name:"오버헤드프레스 (바벨)",sets:5,rir:1,targetReps:5,weight:"5렙 가능 무게 (약 1RM 85%)"},
        {name:"데드리프트",sets:1,rir:1,targetReps:5,weight:"5렙 가능 무게 (약 1RM 85%)"},
      ]},
    ]
  },
  "GZCLP":{
    desc:"Cody Lefever의 선형 점진 과부하 프로그램. 주 4일.\n\nT1 (2x3+): 3렙 가능 무게 (약 1RM 93%) — 마지막 세트 AMRAP\nT2 (3x10): 10렙 가능 무게 (약 1RM 75%)\nT3 (3x15+): 15렙 가능 무게 (약 1RM 65%)\n\n⚠️ T1 실패 시 5회로 전환 → 재실패 시 85% 리셋",
    days:[
      {name:"Day 1 — 스쿼트/OHP", exercises:[
        {name:"스쿼트 (바벨)",sets:2,rir:1,targetReps:3,weight:"3렙 가능 무게 (약 1RM 93%)"},
        {name:"오버헤드프레스 (바벨)",sets:3,rir:1,targetReps:10,weight:"10렙 가능 무게 (약 1RM 75%)"},
        {name:"랫풀다운 (케이블)",sets:3,rir:1,targetReps:15,weight:"15렙 가능 무게 (약 1RM 65%)"},
      ]},
      {name:"Day 2 — 벤치/데드", exercises:[
        {name:"벤치프레스 (바벨)",sets:2,rir:1,targetReps:3,weight:"3렙 가능 무게 (약 1RM 93%)"},
        {name:"데드리프트",sets:3,rir:1,targetReps:10,weight:"10렙 가능 무게 (약 1RM 75%)"},
        {name:"덤벨 로우",sets:3,rir:1,targetReps:15,weight:"15렙 가능 무게 (약 1RM 65%)"},
      ]},
      {name:"Day 3 — 스쿼트/OHP(T2)", exercises:[
        {name:"스쿼트 (바벨)",sets:3,rir:1,targetReps:10,weight:"10렙 가능 무게 (약 1RM 75%)"},
        {name:"오버헤드프레스 (바벨)",sets:2,rir:1,targetReps:3,weight:"3렙 가능 무게 (약 1RM 93%)"},
        {name:"레그 컬",sets:3,rir:1,targetReps:15,weight:"15렙 가능 무게 (약 1RM 65%)"},
      ]},
      {name:"Day 4 — 데드/벤치(T2)", exercises:[
        {name:"데드리프트",sets:2,rir:1,targetReps:3,weight:"3렙 가능 무게 (약 1RM 93%)"},
        {name:"벤치프레스 (바벨)",sets:3,rir:1,targetReps:10,weight:"10렙 가능 무게 (약 1RM 75%)"},
        {name:"케이블 크로스오버",sets:3,rir:1,targetReps:15,weight:"15렙 가능 무게 (약 1RM 65%)"},
      ]},
    ]
  },
  "PPL":{
    desc:"가장 대중적인 주 6일 분할.\nPush → Pull → Legs 순으로 2회 반복.\n\n⚠️ 마지막 세트는 RIR 0 (올인)",
    days:[
      {name:"Push — 가슴/어깨/삼두", exercises:[
        {name:"벤치프레스 (바벨)",sets:4,rir:1,targetReps:8,weight:""},
        {name:"인클라인 벤치프레스",sets:3,rir:1,targetReps:10,weight:""},
        {name:"오버헤드프레스 (바벨)",sets:3,rir:1,targetReps:8,weight:""},
        {name:"사이드 레터럴 레이즈",sets:4,rir:0,targetReps:15,weight:""},
        {name:"케이블 푸시다운",sets:3,rir:0,targetReps:12,weight:""},
        {name:"오버헤드 트라이셉스",sets:3,rir:0,targetReps:12,weight:""},
      ]},
      {name:"Pull — 등/이두", exercises:[
        {name:"데드리프트",sets:3,rir:1,targetReps:5,weight:""},
        {name:"바벨 로우",sets:4,rir:1,targetReps:8,weight:""},
        {name:"랫풀다운 (케이블)",sets:3,rir:1,targetReps:10,weight:""},
        {name:"시티드 로우 (케이블)",sets:3,rir:1,targetReps:10,weight:""},
        {name:"바벨 컬",sets:3,rir:0,targetReps:12,weight:""},
        {name:"해머 컬",sets:3,rir:0,targetReps:12,weight:""},
      ]},
      {name:"Legs — 하체", exercises:[
        {name:"스쿼트 (바벨)",sets:4,rir:1,targetReps:8,weight:""},
        {name:"루마니안 데드리프트",sets:3,rir:1,targetReps:10,weight:""},
        {name:"레그프레스",sets:3,rir:1,targetReps:12,weight:""},
        {name:"레그 익스텐션",sets:4,rir:0,targetReps:15,weight:""},
        {name:"레그 컬",sets:4,rir:0,targetReps:15,weight:""},
        {name:"힙 쓰러스트",sets:3,rir:0,targetReps:12,weight:""},
      ]},
    ]
  },
};
  ...
  return (
    <div>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
        ...
        <span style={{fontWeight:600,fontSize:15,color:C.text}}>{ym.y}년 {mNames[ym.m]}</span>
      ...
      <div style={{display:"flex",gap:10,marginBottom:8,fontSize:10,color:C.muted}}>
        {[["#22c55e","운동"],["#5b9af8","CrossFit"],["#fbbf24","둘 다"]].map(([bg,label])=>(
          <span key={label} style={{display:"flex",alignItems:"center",gap:4}}><span style={{width:10,height:10,background:bg,borderRadius:2,display:"inline-block"}}/>{label}</span>
        ))}
      </div>
...
function ProfileModal({profile,setProfile,history,setHistory,workoutLog,cfLog,onClose}) {
  ...
  const save = () => {
    const np = {...form};
    lsSave("profile",np); setProfile(np);
    ...
    lsSave("history",nh); setHistory(nh);
    onClose();
  };
          ...
          <>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:12}}>
              {[["warmupSets","웜업"],["mainSets","메인"],["cooldownSets","쿨다운"]].map(([k,l])=>(
                <div key={k}><Lbl>{l}</Lbl><Inp type="number" min={0} max={8} value={form[k]??0} onChange={e=>setForm(p=>({...p,[k]:parseInt(e.target.value)||0}))} style={{textAlign:"center",padding:6}}/></div>
              ))}
            </div>
            <Lbl>목표 (하단 배너)</Lbl>
...
function OneRMScreen({profile}) {
  return (
    <div>
      ...
      <p style={{fontSize:11,color:C.muted,marginBottom:14}}>Epley 공식 기반. 메인 세트 무게가 몇 % 강도인지 확인하세요.</p>
...
function WorkoutScreen({profile,workoutLog,setWorkoutLog,cfLog,savedRoutines,setSavedRoutines}) {
  ...
  const deleteCustomEx = (muscle,name) => {
    const updated = {...customExs,[muscle]:(customExs[muscle]||[]).filter(e=>e!==name)};
    saveCustomExs(updated);
    setSelExs(p=>p.filter(e=>e.name!==name));
    setEditEx(null);
  };
  const renameCustomEx = (muscle,oldName,newVal) => {
    const updated = {...customExs,[muscle]:(customExs[muscle]||[]).map(e=>e===oldName?newVal:e)};
    saveCustomExs(updated);
    setSelExs(p=>p.map(e=>e.name===oldName?{...e,name:newVal}:e));
    setEditEx(null);
  };
  ...
  const saveRoutine = () => {
    ...
    const nr = [...savedRoutines,{name:newName,exercises:selExs}];
    setSavedRoutines(nr); lsSave("savedRoutines",nr); setShowSave(false); setNewName("");
  };
  const loadProgram = (progName,dayIdx) => {
    const day = PROGRAMS[progName]?.days[dayIdx];
    if(!day) return;
  ...
  const startWorkout = dateForRecord => {
    ...
    setRoutineName(rn); setActiveDate(dateForRecord||nowStr());
    ...
    setWorkoutData(selExs.map(ex=>{
      const sets=[
        ...Array.from({length:wm},()=>({weight:"",reps:"",isMain:false,isWarmup:true,isCooldown:false,done:false})),
        ...Array.from({length:ex.sets||mm},()=>({weight:"",reps:"",isMain:true,isWarmup:false,isCooldown:false,done:false})),
        ...Array.from({length:cm},()=>({weight:"",reps:"",isMain:false,isWarmup:false,isCooldown:true,done:false})),
      ];
      return {name:ex.name,targetSets:ex.sets||mm,targetRir:ex.rir??2,targetReps:ex.targetReps||"",weightNote:ex.weightNote||"",sets,bestWeight:getBestWeight(ex.name)};
    }));
  ...
  const toggleRest = () => {
    ...
    else{const dur=Math.floor((Date.now()-restStart)/1000);setTotalRestSec(p=>p+dur);setIsResting(false);setRestStart(null);setCurRestSec(0);setRestLogs(p=>({...p,[curExIdx]:[...(p[curExIdx]||[]),dur]}));}
  };
  ...
  const addSet=(type="main")=>setWorkoutData(p=>{
    ...
    const ns={weight:"",reps:"",isMain:type==="main",isWarmup:type==="warmup",isCooldown:type==="cooldown",done:false};
  ...
  const finish = () => {
    ...
    const result={tt,vol:Math.round(vol),sets,cal,totalRest:totalRestSec,routineName,date:activeDate,exercises:workoutData.map(ex=>({name:ex.name,targetReps:ex.targetReps,sets:ex.sets}))};
    setSummary(result);
    ...
    <div>
      ...
      {Object.keys(exMap).length>0&&(
        <GCard style={{marginTop:10}}>
          ...
          <p style={{fontSize:11,color:C.muted,marginBottom:10}}>메인 세트 기준 볼륨(kg). 꾸준히 올라가면 점진적 과부하가 잘 되고 있는 것입니다.</p>
          ...
          :logs.map((log,li)=>(
            <GCard key={li}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                ...
                <button onClick={()=>{const n={...workoutLog};n[selDay]=n[selDay].filter((_,i)=>i!==li);if(!n[selDay].length)delete n[selDay];lsSave("workoutLog",n);setWorkoutLog(n);}} style={{background:"none",border:"none",color:C.red,cursor:"pointer",fontSize:13}}>삭제</button>
              </div>
              ...
              {(log.exercises||[]).map((ex,ei)=>(
                <div key={ei} style={{marginBottom:6}}>
                  ...
                  {ex.sets.filter(s=>s.weight||s.reps).map((s,si)=>{
                    ...
                    return <p key={si} style={{fontSize:12,color:C.muted,paddingLeft:8}}>{s.isMain?"메인":s.isWarmup?"웜업":"쿨다운"}: {s.weight||"-"}kg × {s.reps||"-"}rep {achieved}</p>;
                  })}
                </div>
              ))}
            </GCard>
    ...
    <div>
      ...
      {planTab==="programs" && (
        <div>
                ...
                <div style={{padding:"12px 14px 14px",background:C.card2,borderTop:`0.5px solid ${C.border}`}}>
                  ...
                  <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                    {prog.days.map((day,di)=>(
                      <button key={di} onClick={()=>loadProgram(progName,di)}
                        style={{padding:"7px 14px",border:`0.5px solid ${C.accentL}`,borderRadius:16,fontSize:12,cursor:"pointer",background:"#1e3a6e",color:C.accentL,fontWeight:500}}>
          ...
          {selExs.length>0&&<div style={{padding:"10px 12px",background:"#1e3a1e",borderRadius:8,border:`0.5px solid ${C.green}`,marginBottom:10}}>
            <p style={{fontSize:12,color:C.green,fontWeight:600}}>✓ {selExs.length}개 선택됨 — 커스텀 탭에서 확인/수정 후 시작</p>
          </div>}
          {selExs.length>0&&<PBtn onClick={()=>startWorkout(selDay||nowStr())}>바로 시작 →</PBtn>}
        </div>
      )}
      ...
      {planTab==="custom" && (
        <div>
          ...
          {selExs.length>0&&(
            <GCard>
              <Lbl>선택된 운동 — ↑↓ 버튼으로 순서 변경</Lbl>
              {selExs.map((ex,i)=>(
                <div key={i} draggable onDragStart={()=>handleDragStart(i)} onDragOver={e=>handleDragOver(e,i)} onDrop={handleDrop}
                  style={{background:C.card2,borderRadius:8,padding:10,marginBottom:6,border:`0.5px solid ${C.border}`}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
                    <div style={{display:"flex",alignItems:"center",gap:4}}>
                      <div style={{display:"flex",flexDirection:"column",gap:2}}>
                        <button onClick={()=>moveUp(i)} style={{background:"none",border:"none",color:C.muted,cursor:"pointer",fontSize:12,padding:"0 4px",lineHeight:1}}>▲</button>
                        <button onClick={()=>moveDown(i)} style={{background:"none",border:"none",color:C.muted,cursor:"pointer",fontSize:12,padding:"0 4px",lineHeight:1}}>▼</button>
                      </div>
                      <span style={{fontSize:13,fontWeight:500,color:C.text}}>{ex.name}</span>
                    </div>
                  ...
                  {ex.weightNote&&<p style={{fontSize:11,color:C.amber,marginBottom:6}}>📌 {ex.weightNote}</p>}
    ...
    return (
      <div>
        <div style={{borderRadius:12,padding:14,marginBottom:10,border:`2.5px solid ${isResting?C.green:C.red}`,background:isResting?C.card:"#1a0800",position:"relative",overflow:"hidden"}}>
          {!isResting&&<div style={{position:"absolute",inset:0,display:"flex",alignItems:"flex-end",justifyContent:"space-around",pointerEvents:"none"}}>
        ...
        <GCard>
          ...
          {ex.targetReps&&<p style={{fontSize:11,color:C.accentL,marginBottom:6}}>🎯 목표 렙: <strong>{ex.targetReps}rep</strong></p>}
          ...
          {ex.sets.map((s,si)=>(
            <div key={si} style={{display:"grid",gridTemplateColumns:"24px 1fr 1fr 30px 30px 22px",gap:4,alignItems:"center",padding:"4px 0",borderBottom:`0.5px solid ${C.border}`,opacity:isResting?0.4:1,background:s.isMain?"#1e2a1a":s.isCooldown?"#2a1e00":"transparent",borderRadius:4}}>
              ...
              <NumInp value={s.weight} onChange={v=>updSet(si,"weight",v)} placeholder="kg" disabled={isResting} style={{border:`0.5px solid ${s.isMain?C.green:s.isCooldown?C.amber:C.border}`}}/>
              <NumInp value={s.reps} onChange={v=>updSet(si,"reps",v)} placeholder="rep" disabled={isResting} style={{border:`0.5px solid ${s.isMain?C.green:s.isCooldown?C.amber:C.border}`}}/>
          ...
          <div style={{display:"flex",gap:6,marginTop:6}}>
            <button onClick={()=>addSet("warmup")} style={{flex:1,fontSize:11,padding:"5px 4px",border:`0.5px solid ${C.border}`,borderRadius:7,background:"transparent",cursor:"pointer",color:C.muted}}>+ 웜업</button>
          ...
          {exRestLogs.length>0&&<div style={{marginTop:8,padding:"6px 10px",background:C.card2,borderRadius:8}}><Lbl>세트간 휴식</Lbl>{exRestLogs.map((r,i)=><div key={i} style={{fontSize:12,color:C.mutedL,padding:"2px 0"}}>휴식 {i+1}: {fmtT(r)}</div>)}</div>}
        </GCard>
        <div style={{display:"flex",gap:8}}>
...
function CrossfitScreen({cfLog,setCfLog,workoutLog,profile}) {
  ...
  const loadHero=h=>{setSelHero(h);setWodName(h.name);setMovements(h.movements.map(m=>({...m})));const mk=Object.keys(CF_SCORE_FORMATS).includes(h.mode)?h.mode:"For Time";setWodFormat(mk);if(h.totalMin)setTotalMin(h.totalMin);if(h.rounds)setRounds(h.rounds);if(h.roundSec)setRoundSec(h.roundSec);};
  ...
  const getLatest=name=>{const all=[];Object.entries(cfLog).forEach(([date,logs])=>(logs||[]).forEach(l=>{if(l.name===name)all.push({...l,date});}));return all.sort((a,b)=>b.date.localeCompare(a.date))[0]||null;};
  const wodHistory=useMemo(()=>{const map={};Object.entries(cfLog).sort(([a],[b])=>a.localeCompare(b)).forEach(([date,logs])=>{(logs||[]).forEach(l=>{if(!map[l.name])map[l.name]=[];map[l.name].push({...l,date});});});return map;},[cfLog]);
    ...
    <div>
      ...
      {Object.keys(wodHistory).length>0&&(
        <GCard>
          ...
          {Object.entries(wodHistory).map(([name,recs])=>{const latest=recs[recs.length-1];return(
  ...
  if(phase==="dayview"){
    ...
    return <div>
      ...
      {logs.length===0?<GCard><p style={{color:C.muted,textAlign:"center",padding:"20px 0",fontSize:13}}>기록 없음</p></GCard>:logs.map((l,li)=>(
        <GCard key={li}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
            ...
            <div style={{display:"flex",gap:6,alignItems:"center"}}>
              ...
              <button onClick={()=>{const n={...cfLog};n[selDay]=n[selDay].filter((_,i)=>i!==li);if(!n[selDay].length)delete n[selDay];lsSave("cfLog",n);setCfLog(n);}} style={{background:"none",border:"none",color:C.red,cursor:"pointer",fontSize:13}}>삭제</button>
            </div>
          </div>
          <div style={{display:"flex",gap:6,marginBottom:6,alignItems:"center"}}>
  ...
  if(phase==="setup") return (
    <div>
      ...
      {cfTab==="hero"&&(<>
        ...
        {selHero&&(
          <GCard style={{background:"#1e2a3a"}}>
            {(()=>{const lat=getLatest(selHero.name);return lat&&(
      ...
      {cfTab==="custom"&&(<>
        ...
        {wodName&&(()=>{const lat=getLatest(wodName);return lat&&(
  ...
  if(phase==="done"){
    const lastRec=(()=>{const dl=cfLog[activeDate]||[];return dl.find(l=>l.name===(wodName||wodFormat))||null;})();
    const pr3=(profile.squat||0)+(profile.bench||0)+(profile.dead||0);
    const instaText=lastRec?[
      ...
      pr3?`💪 3대 합계: ${pr3}kg`:"",``,`${HASHTAG} #크로스핏 #CrossFit #WOD #${lastRec.name.replace(/\s/g,"")}`,
...
export default function App() {
  ...
  const [profile,setProfile] = useState(()=>ls("profile",{squat:0,bench:0,dead:0,weight:70,nick:"",photo:null,goal:"",warmupSets:0,mainSets:3,cooldownSets:0}));
  ...
  useEffect(()=>lsSave("profile",profile),[profile]);
